function string=strjoin(pieces,delimiter)
%IMPLODE/STRJOIN    Joins strings with delimiter in between.
%   STRJOIN(PIECES,DELIMITER) returns a string containing all the
