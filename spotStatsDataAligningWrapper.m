function spotStatsDataAligningWrapper()


trainingSets={     {'7_3_09_N2_25C_xol1cy5_sea1A594_sdc2tmr_1_10','trainingSet_alexa_Cel_sea1.mat'},...
...
% {'3_1_09_N2_25C_xol1cy5_sdc2tmr','trainingSet_cy_Cel_xol1.mat'},...
                ...
                try
                    for iTSCheck=1:length(trainingSets)
                        if strcmp(dirs(iDir).name,trainingSets{iTSCheck}{1})
                            spotStatsDataAligning(dirs(iDir).name,1);
                                disp(toc);
                                disp('Done');
                                break
                    ...
                    parsaveProblem(ME);
                    disp(['******** PROBLEM in ' dirs(iDir).name ' in ' tss(iTS).name]);
                end;
            end;
        else
